    ...
    <div className="grid gap-5 lg:grid-cols-2">
      ...
      <div className="rounded-lg border border-brand/30 bg-brand-light/20 p-4 lg:col-span-2">
        ...
        <p className="mt-1 text-xs text-ink-muted">
          与 MCP 独立。基线内置（计算器 / HTTP / 时间 / 知识库检索）与自定义 HTTP 始终可用；外呼与执行类内置（web_search、code_execution、合规检测、触发流程 /
          钩子）须在此勾选后才进入 function schema。生图/生视频亦依赖本项；绑定知识库时 knowledge_search 自动可用。
        </p>
