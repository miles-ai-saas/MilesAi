...
function FlowVersionHistoryFooter({
  vm,
  currentVersion,
  onClose,
}: {
...
function FlowVersionDiffPanel({ vm, currentVersion }: { vm: FlowVersionHistoryVm; currentVersion: number }) {
...
function FlowVersionListPanel({ vm, currentVersion }: { vm: FlowVersionHistoryVm; currentVersion: number }) {
...
function FlowVersionPreviewPanel({ vm }: { vm: FlowVersionHistoryVm }) {
