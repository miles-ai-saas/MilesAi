...
**最近同步：** 2026-06-01 新增业务中心（广告公司试点）排期；其余与 2026-05-28 对齐
...
| 阶段 | 项 | 优先级 | 状态 |
|------|-----|--------|------|
| Phase 0 | 设计文档 + 空壳 `BusinessShell` + 三分区导航 | P1 | ⬜ 文档 ✅ |
...
| Phase 4 | 服务线 Agent/Flow 模板、项目上下文 RAG | P2 | ⬜ |
| Phase 5 | 服务线模板市场、ERP 对接 | 按需 | ⬜ |
