...
| A2A 对外 Server 流式 | 🔶 | Card、`message/send`、`contextId` 多轮、`tasks/get` / `tasks/cancel` ✅；`message/stream`、`tasks/resubscribe`、`pushNotificationConfig/*` 待做；产物下载亦缺（见 [a2a.md](../guides/a2a.md)） |
