...
const QUICK_LINKS = [
  { href: "/agents/chat", label: "对话工作台", desc: "与智能体对话调试", accent: true },
  { href: "/agents", label: "智能体", desc: "查看与管理智能体" },
  { href: "/kb", label: "知识库", desc: "文档与检索能力" },
  { href: "/flows", label: "流程编排", desc: "可视化编排与发布" },
  { href: "/compliance", label: "合规", desc: "敏感词库与内容安全" },
  { href: "/monitor", label: "监控", desc: "运行指标与告警" },
];
...
export default function WorkbenchOverviewPage() {
  ...
  const statCards = [
    { label: "智能体", value: stats.agents, href: "/agents" },
    { label: "知识库", value: stats.kbs, href: "/kb" },
    { label: "流程", value: stats.flows, href: "/flows" },
    { label: "提示词模版", value: stats.prompts, href: "/prompts" },
    { label: "模型配置", value: stats.models, href: "/models" },
    { label: "任务", value: stats.tasks, href: "/tasks" },
  ];
  ...
  return (
    <div className="resource-page-shell">
      <PageHeader
        ...
        action={
          <Link href="/agents/chat" className="btn-primary">
            进入对话工作台
          </Link>
        }
      />
