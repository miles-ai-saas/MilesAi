...
if TYPE_CHECKING:
    from miles_ai.integrations.embeddings.providers.base import EmbeddingProvider
...
def _register_builtin_providers() -> None:
    ...
    from miles_ai.integrations.embeddings.providers.litellm import LiteLLMEmbeddingProvider
    from miles_ai.integrations.embeddings.providers.local import LocalEmbeddingProvider
