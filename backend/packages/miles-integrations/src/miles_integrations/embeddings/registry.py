...
if TYPE_CHECKING:
    from miles_integrations.embeddings.providers.base import EmbeddingProvider
...
def _register_builtin_providers() -> None:
    ...
    from miles_integrations.embeddings.providers.litellm import LiteLLMEmbeddingProvider
    from miles_integrations.embeddings.providers.local import LocalEmbeddingProvider
    from miles_integrations.embeddings.providers.openai_compatible import (
