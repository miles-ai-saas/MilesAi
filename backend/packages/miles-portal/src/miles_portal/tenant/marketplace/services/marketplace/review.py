...
from miles_portal.tenant.marketplace.models import MarketplaceApp, MarketplaceAppStatus
from miles_portal.tenant.marketplace.schemas.marketplace import MarketplaceAppOut
