...
from miles_portal.tenant.a2a.services.peer_refs import list_all_agent_a2a_peer_refs
from miles_portal.tenant.agents.schemas.agent import (
    A2aPeerRefOut,
    AgentOut,
    SubAgentRefOut,
)
...
if TYPE_CHECKING:
    from miles_portal.tenant.agents.services.agent.service import AgentService
