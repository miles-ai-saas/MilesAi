...
from miles_portal.tenant.a2a.services.peer_refs import (
    normalize_peer_refs,
...
from miles_portal.tenant.agents.schemas.agent import AgentCreate, AgentOut, AgentUpdate
...
from miles_portal.tenant.agents.services.sub_agents import (
...
class AgentCrudMixin(BaseService):
    ...
    async def create_agent(self, body: AgentCreate) -> AgentOut:
        ...
        from miles_portal.tenant.system.services.quota import assert_can_create_agent
