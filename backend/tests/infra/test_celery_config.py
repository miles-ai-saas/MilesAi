...
def test_celery_task_annotations_for_long_running_jobs():
    ...
    ingest = annotations["app.workers.tasks.ingest.ingest_document"]
    ...
    video = annotations["app.workers.tasks.generative.run_generative_video_job"]
    ...
    image = annotations["app.workers.tasks.generative.run_generative_image_job"]
