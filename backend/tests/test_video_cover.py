...
from app.tenant.media_assets.schemas.media_asset import MediaAssetOut


def test_extract_video_cover_without_ffmpeg():
    with patch("app.integrations.generative.video.cover.shutil.which", return_value=None):
