...
from miles_integrations.rerank.constants import INVOKE_MODE_DASHSCOPE, INVOKE_MODE_OPENAI_COMPATIBLE
from miles_integrations.rerank.model_meta import (
    invoke_mode_from_model,
    resolve_rerank_openai_compat_url,
)
from miles_integrations.rerank.providers.dashscope import DashScopeRerankProvider
