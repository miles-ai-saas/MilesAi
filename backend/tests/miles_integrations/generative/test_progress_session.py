...
``miles_integrations.generative.jobs.progress`` 在 Celery 生成任务（``asyncio.run``，
...
from miles_integrations.generative.jobs import progress as progress_mod
from miles_integrations.generative.jobs.errors import GenerativeJobCancelled
from miles_integrations.generative.jobs.progress import (
