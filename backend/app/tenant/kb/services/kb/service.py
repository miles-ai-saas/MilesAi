...
from app.tenant.kb.services.kb.core import KnowledgeBaseCoreMixin
from app.tenant.kb.services.kb.documents import KnowledgeBaseDocumentMixin
from app.tenant.kb.services.kb.search import KnowledgeBaseSearchMixin
